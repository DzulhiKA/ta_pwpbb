<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="<?= base_url('auth'); ?>"><b>auto2000</b>Mobil</a>
        </div>
        <!-- /.login-logo -->
        <div class="card">
            <div class="card-body login-card-body">
                <p class="login-box-msg">Dealer Resmi Toyota</p>
                ...
                <form action="<?= base_url('auth'); ?>" method="post">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <button type="submit" class="btn btn-primary btn-block navbar-red">Sign In</button>
                        </div>
                        <!-- /.col -->
                    </div>
                </form>
